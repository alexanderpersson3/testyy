...
describe('Social Features', () => {
  ...
  describe('Likes', () => {
    ...
    it('should get recipe likes count', async () => {
      ...
      const response = await request(app).get(`/api/social/recipes/${testRecipeId}/likes`);
  ...
  describe('Comments', () => {
    ...
    it('should get recipe comments', async () => {
      ...
      const response = await request(app).get(`/api/social/recipes/${testRecipeId}/comments`);
  ...
  describe('Following', () => {
    ...
    it('should get user followers', async () => {
      ...
      const response = await request(app).get(`/api/social/users/${testUserId}/followers`);
    ...
    it('should get users being followed', async () => {
      ...
      const response = await request(app).get(`/api/social/users/${testUserId}/following`);
