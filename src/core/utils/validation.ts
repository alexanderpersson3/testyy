...
import type { RecipeIngredient, RecipeInstruction, BaseRecipe } from '../types/express.js';
...
export function validateRecipe(recipe: Partial<BaseRecipe>): ValidationError[] {
  ...
  if (!recipe.instructions?.length) {
    ...
    recipe.instructions.forEach((instruction: RecipeInstruction, index: number) => {
...
export function validateRecipeStrict(recipe: BaseRecipe): ValidationError[] {
