 ...
 */
function parseIngredient(ingredient: string): ParsedIngredient | null {
  try {
    // Clean up the input
 ...
 */
function parseStructuredIngredient(ingredient: string): IngredientMatch | null {
 ...
 */
function parseUnstructuredIngredient(ingredient: string): IngredientMatch | null {
