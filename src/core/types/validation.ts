import { z } from 'zod';
import type { Request, Response, NextFunction, Middleware } from './express.js';
...
// Helper types for request validation
...
export type ValidationFunction<T> = (value: unknown) => Promise<T> | T;
