...
export function isRecipeSource(
  source: any
): source is Pick<Recipe, 'title' | 'cuisine' | 'difficulty'> {
  return (
...
export interface SearchFacets {
  cuisineTypes: Array<{ value: string; count: number }>;
  mealTypes: Array<{ value: string; count: number }>;
  dietaryRestrictions: Array<{ value: string; count: number }>;
