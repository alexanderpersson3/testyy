...
export function isSubscriptionMessage(message: WebSocketMessage): message is SubscriptionMessage {
  return (
...
export function isDataMessage(message: WebSocketMessage): message is DataMessage {
