...
export interface VariationStats {
  ...
  dietaryBreakdown: { [key: string]: number };
  commonModifications: { change: string; count: number }[];
}
 ...
 */
export type UpdateVariationRequest = Partial<
  Omit<RecipeVariation, '_id' | 'authorId' | 'createdAt' | 'updatedAt'>
>;
