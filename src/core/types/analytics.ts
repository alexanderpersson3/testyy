...
export interface AnalyticsService {
  ...
  getActivityTimeline(userId: ObjectId, options: { startDate?: Date; endDate?: Date }): Promise<ActivityTimelineEntry[]>;
  getUsageMetrics(userId: ObjectId, options: { period: string }): Promise<UsageMetrics>;
...
export interface FilterMetrics {
  ...
  filterUsageByType: Array<{ type: string; count: number }>;
  popularCombinations: Array<{ filters: string[]; count: number }>;
  trendingFilters: Array<{ type: string; trend: number }>;
}
