...
export interface BaseCollection {
  ...
  isPublic: boolean;
  recipeIds: ObjectId[];
  collaboratorIds: ObjectId[]; // Users who can add/remove recipes
...
export interface CollectionWithDetails extends CollectionDocument {
  ...
  isFollowing?: boolean; // Whether the current user is following this collection
  isCollaborator?: boolean; // Whether the current user is a collaborator
}
