...
import { RecipeSearchFilters, RecipeSearchOptions } from './recipe-search';
import { RecipeStats, RecipePermissions } from './recipe-analytics';
...
export interface BaseShoppingList {
  ...
  recipeIds: ObjectId[];
  servingsMultiplier: Record<string, number>; // recipeId -> multiplier
  isArchived: boolean;
  createdAt: Date;
  updatedAt: Date;
}
