...
import type {
  ...
  MongoFindOptions,
  ModifyResult
} from '../../../core/database/types/mongodb.types.js';
import {
  MongoNotFoundError,
  MongoValidationError,
  MongoWriteError,
  MongoQueryError
} from '../../../core/errors/mongodb.errors.js';
import { ValidationError } from '../../../core/errors/validation.error.js';
import { isMongoDocument, isObjectId } from '../../../core/database/types/mongodb.types.js';
import { DatabaseService } from '../../../core/database/database.service.js';
import { WebSocketService } from '../../../core/services/websocket.service.js';
...
export interface RecipeServiceInterface {
   ...
   * @returns Statistics about recipes in the system
   * @throws {MongoQueryError} If the database operation fails
   */
...
export class RecipeService implements RecipeServiceInterface {
  ...
  async getStats(): Promise<RecipeStats> {
    ...
    try {
      ...
      const [stats] = await this.recipesCollection
      ...
      logger.error('Failed to get recipe stats:', error);
      throw new MongoQueryError('Failed to get recipe stats', error);
    }
  }
}
