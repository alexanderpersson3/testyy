...
// Block a user
router.post('/block/:userId', auth, rateLimiter.api(), async (req, res) => {
  try {
...
// Unblock a user
router.delete('/block/:userId', auth, rateLimiter.api(), async (req, res) => {
  try {
...
// Get blocked users
router.get('/blocks', auth, rateLimiter.api(), async (req, res) => {
  try {
...
router.post(
  ...
  async (req, res) => {
    try {
      await moderationManager.muteUser(req.user.id, req.params.userId, req.body.duration);
...
// Unmute a user
router.delete('/mute/:userId', auth, rateLimiter.api(), async (req, res) => {
  try {
...
// Get muted users
router.get('/mutes', auth, rateLimiter.api(), async (req, res) => {
  try {
...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      await moderationManager.reportContent(req.user.id, contentType, contentId, reason, details);
...
router.get('/reports', auth, rateLimiter.admin(), async (req, res) => {
  try {
    const filters = {
