...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      const result = await sessionManager.refreshSession(req.body.refreshToken, deviceInfo);
...
router.post('/logout', auth, rateLimiter.auth(), async (req, res) => {
  try {
...
router.post('/logout-all', auth, rateLimiter.auth(), async (req, res) => {
  try {
...
// Get active sessions
router.get('/active', auth, rateLimiter.auth(), async (req, res) => {
  try {
...
router.post('/logout/:sessionId', auth, rateLimiter.auth(), async (req, res) => {
  try {
