...
export class LoggingService {
  ...
  // Log error messages
  error(message: string, error?: Error, request?: Request) {
  ...
  // Log HTTP requests
  http(message: string, request: Request) {
    const logMessage = this.formatMessage(message, undefined, request);
    Logger.http(logMessage);
  }

  // Format log message with additional context
  private formatMessage(message: string, error?: Error, request?: Request): string {
