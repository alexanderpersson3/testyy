...
router.patch(
  ...
  async (req, res) => {
    try {
      const settings = await settingsManager.updateMeasurementSettings(req.user.id, req.body);
...
router.patch(
  ...
  async (req, res) => {
    try {
      const settings = await settingsManager.updateNotificationSettings(req.user.id, req.body);
...
router.patch(
  ...
  async (req, res) => {
    try {
      const settings = await settingsManager.updateAppearanceSettings(req.user.id, req.body);
...
router.patch(
  ...
  async (req, res) => {
    try {
      const settings = await settingsManager.updatePrivacySettings(req.user.id, req.body);
...
// Clear app cache
router.post('/clear-cache', authenticateToken, rateLimiter.api(), async (req, res) => {
  try {
...
// Delete account
router.delete('/account', authenticateToken, rateLimiter.api(), async (req, res) => {
  try {
