...
class SubscriptionService {
  ...
  async createOrUpdateSubscription(userId, platform, purchaseData) {
    ...
    const subscription = {
      ...
      purchase_token:
        platform === this.PLATFORMS.ANDROID ? purchaseData.purchaseToken : purchaseData.receiptData,
    ...
    await db
      ...
      .updateOne({ user_id: subscription.user_id }, { $set: subscription }, { upsert: true });
