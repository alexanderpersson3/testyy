...
router.post(
  ...
  async (req, res) => {
    try {
      const result = await contactManager.startPhoneVerification(
        req.user.id,
...
router.post(
  ...
  async (req, res) => {
    try {
      const result = await contactManager.findFriendsByContacts(
        req.user.id,
        req.body.contacts
      );
...
router.post(
  ...
  async (req, res) => {
    try {
      const result = await contactManager.sendInvites(
        req.user.id,
