...
export interface CreateIngredientDTO extends Omit<BaseIngredient, 'source' | 'createdAt' | 'updatedAt'> {
    price?: {
        amount: number;
        currency: string;
        store?: string;
...
export interface UpdateIngredientDTO extends Partial<Omit<BaseIngredient, 'source' | 'createdAt' | 'updatedAt'>> {
    price?: {
        amount: number;
        currency: string;
        store?: string;
