 ...
 * Timer event types
 */
export type TimerEventType = 'timer:start' | 'timer:pause' | 'timer:stop' | 'timer:complete' | 'timer:update' | 'timer:alert' | 'group:start' | 'group:pause' | 'group:stop' | 'group:complete' | 'group:update';
/**
