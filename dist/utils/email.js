 ...
 */
export async function sendShareEmail(to, shareUrl, recipeName, fromUserId) {
 ...
 */
export const sendInvitationEmail = async (email, invitationCode, invitedBy) => {
 ...
 */
function generatePlainTextEmail(fromName, recipeName, shareUrl) {
    return `
 ...
 */
function generateHtmlEmail(fromName, recipeName, shareUrl) {
    return `
<!DOCTYPE html>
<html>
<head>
