 ...
 */
export function generateEmbedCode(url, options = {}) {
    const { width = '100%', height = '600px', theme = 'light', showImage = true, showDescription = true, showIngredients = true, showInstructions = true, showMetadata = true, responsive = true, } = options;
 ...
 */
export function generateEmbedStyles(theme = 'light') {
