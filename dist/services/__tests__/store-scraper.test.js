...
describe('StoreScraper', () => {
    ...
    describe('scrapeMatSparPrice', () => {
      ...
      `;
            ...
            expect(mockedRedis.setex).toHaveBeenCalledWith(cacheKey, 3600, expect.any(String));
        });
    ...
    describe('scrapeStore', () => {
        ...
        it('should throw error if store not found', async () => {
            ...
            getDb.mockResolvedValueOnce(mockDb);
...
//# sourceMappingURL=store-scraper.test.js.map