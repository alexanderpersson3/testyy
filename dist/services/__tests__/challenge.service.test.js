...
describe('ChallengeService', () => {
    ...
    describe('createChallenge', () => {
        it('should create a new challenge', async () => {
            ...
            expect(wsService.broadcast).toHaveBeenCalledWith(expect.stringContaining('new_challenge'));
        });
    });
    describe('joinChallenge', () => {
        ...
        it('should not allow joining completed challenges', async () => {
            ...
            const result = await db.collection('challenges').insertOne(challenge);
            await expect(challengeService.joinChallenge(result.insertedId.toString(), testUser1Id)).rejects.toThrow('Challenge is not open for joining');
        });
    });
    describe('processCookingSession', () => {
        it('should update progress for count-based challenge', async () => {
            ...
            const challengeResult = await db.collection('challenges').insertOne(challenge);
            ...
            await db.collection('user_challenge_progress').insertOne(progress);
        ...
        it('should update streak for streak-based challenge', async () => {
            ...
            const progressResult = await db.collection('user_challenge_progress').insertOne(progress);
