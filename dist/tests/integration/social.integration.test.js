...
describe('SocialService Integration Tests', () => {
    ...
    describe('User Safety', () => {
        ...
        test('should handle content reporting', async () => {
            ...
            const reportId = await socialService.reportContent(testUser1._id, 'story', story._id, 'inappropriate', 'Test description');
    ...
    describe('Story Sharing', () => {
        test('should share story with specific user', async () => {
            const story = await TestDatabase.createTestStory(testUser1._id);
            const shareId = await socialService.shareStory(story._id, testUser2._id, testUser1._id, 'Check this out!');
    ...
    describe('Profile Customization', () => {
        ...
        test('should respect privacy settings', async () => {
            ...
            const story = await TestDatabase.createTestStory(testUser1._id);
            const commentPromise = socialService.addComment(story._id, testUser2._id, 'Test comment');
...
//# sourceMappingURL=social.integration.test.js.map