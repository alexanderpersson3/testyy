...
router.get('/activity', auth, rateLimitMiddleware.api(), validateRequest(dateRangeSchema.partial()), asyncHandler(async (req, res) => {
    if (!req.user) {
...
// Get usage metrics
router.get('/usage', auth, rateLimitMiddleware.api(), validateRequest(z.object({
...
router.get('/endpoint-metrics', auth, rateLimitMiddleware.api(), validateRequest(dateRangeSchema), asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new ValidationError('Authentication required');
    }
    try {
...
// Get system metrics
router.get('/system-metrics', auth, rateLimitMiddleware.api(), validateRequest(dateRangeSchema), asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new ValidationError('Authentication required');
    }
    try {
...
router.get('/error-distribution', auth, rateLimitMiddleware.api(), validateRequest(dateRangeSchema), asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new ValidationError('Authentication required');
    }
    try {
...
// Get slow endpoints
router.get('/slow-endpoints', auth, rateLimitMiddleware.api(), validateRequest(dateRangeSchema), asyncHandler(async (req, res) => {
    if (!req.user) {
        throw new ValidationError('Authentication required');
    }
    try {
